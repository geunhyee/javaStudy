...
public class VariableMain {
	 ...
	 * 그 속성으로는 색상, 브랜드, 최대 속도 .. 이 올 수 있고
	 * 매서드로는 가속, 정지, 방향 전환 과 같은 동작이 포함될 수 있음.
	 * 
	 ...
	 **/
		...
		System.out.println(fruits.indexOf("banana"));		//존재하지 않으면 -1을 리턴함
		...
		String name="Sam Kim";
		// name 문자열의 공백을 찾아서
		// Sam이라는 String last 변수에 담아 출력하시오.
		...
		String first = name.substring(4,7);
		System.out.println(first);
//		String last =name.substring(6, 7);
//		System.out.println(last);
		String firString = name.substring(nmLen + 1);
...
//		정수 타입을 문자열과 더하면 문자열이 됨.
		String strCaString = intNum + "";
		System.out.println(strCaString + 100);
