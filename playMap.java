...
public class playMap {
	...
	public static void main(String[] args) {
		ArrayList<String> playList = new ArrayList<String>(
				Arrays.asList("Super Shy:NewJeans",
...
//		Collections.sort(singer);
		...
		while(true) {
			...
			if(inputSinger.equalsIgnoreCase("q")){
				break;
			}
			
			ArrayList<String> songList = singerMap.get(inputSinger);
			if (songList != null) {
				System.out.println(inputSinger + "의 노래 리스트:");
